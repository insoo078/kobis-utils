...
public class NcbiTaxonomyNameThread extends FileThread implements Runnable{
	private Map<String, String> map;

	public NcbiTaxonomyNameThread(String filename, String serviceName, CountDownLatch latch) {
