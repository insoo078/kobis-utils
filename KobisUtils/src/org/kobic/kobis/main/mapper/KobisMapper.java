...
public interface KobisMapper {
	...
	public int insertE1Culture( Map<String, String> map );
	public int insertE1Store( Map<String, String> map );
	public int insertE1Distribution( Map<String, String> map );
	public int insertE1Reference( Map<String, String> map );
	public int insertE1Paten( Map<String, String> map );
	public int insertT2MappedCommon( D1CommonVO d1CommonVo );
